...
def generated_maven_jars():
    ...
    if "javax_annotation_api_mvn" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/javax/annotation/javax.annotation-api/1.2/javax.annotation-api-1.2.jar"],        )
    ...
    if "org_apache_karaf_features_core" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/karaf/features/org.apache.karaf.features.core/4.2.2/org.apache.karaf.features.core-4.2.2.jar"],        )
    if "org_apache_karaf_shell_console" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/karaf/shell/org.apache.karaf.shell.console/4.2.2/org.apache.karaf.shell.console-4.2.2.jar"],        )
    if "org_apache_karaf_shell_core" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/karaf/shell/org.apache.karaf.shell.core/4.2.2/org.apache.karaf.shell.core-4.2.2.jar"],        )
    ...
    if "org_apache_karaf_jaas" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/karaf/jaas/org.apache.karaf.jaas.modules/4.2.2/org.apache.karaf.jaas.modules-4.2.2.jar"],        )
    if "org_apache_karaf_system_core" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/apache/karaf/system/org.apache.karaf.system.core/4.2.2/org.apache.karaf.system.core-4.2.2.jar"],        )
    ...
    if "apache_karaf" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/onosproject/apache-karaf-offline/4.2.2-offline-20190103/apache-karaf-offline-4.2.2-offline-20190103.tar.gz"],        )
    ...
    if "openstack4j_core" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/pacesys/openstack4j-core/3.1.0/openstack4j-core-3.1.0.jar"],        )
    if "openstack4j_http_connector" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/pacesys/openstack4j/connectors/openstack4j-http-connector/3.1.0/openstack4j-http-connector-3.1.0.jar"],        )
    if "openstack4j_httpclient" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/pacesys/openstack4j/connectors/openstack4j-httpclient/3.1.0/openstack4j-httpclient-3.1.0.jar"],        )
    ...
    if "snakeyaml" not in native.existing_rules():
        java_import_external(
            ...
            licenses = ["notice"],
            jar_urls = ["https://repo1.maven.org/maven2/org/yaml/snakeyaml/1.15/snakeyaml-1.15.jar"],        )
    ...
    if "slf4j_simple" not in native.existing_rules():
            java_import_external(
                ...
                licenses = ["notice"],
                jar_urls = ["https://repo1.maven.org/maven2/org/slf4j/slf4j-simple/1.7.1/slf4j-simple-1.7.1.jar"], )
    if "log4j" not in native.existing_rules():
            java_import_external(
                name = "log4j",
                jar_sha256 = "1d31696445697720527091754369082a6651bd49781b6005deb94e56753406f9",
                licenses = ["notice"],
                jar_urls = ["https://repo1.maven.org/maven2/log4j/log4j/1.2.17/log4j-1.2.17.jar"],)
    if "onlab_misc" not in native.existing_rules():
                        java_import_external(
                            name = "onlab_misc",
                            jar_sha256 = "d9271057e609038404adc5a26af1338fa59e5e70ef147e47261da42639ff4a06",
                            licenses = ["notice"],
                            jar_urls = ["https://repo1.maven.org/maven2/org/onosproject/onlab-misc/1.14.1/onlab-misc-1.14.1.jar"], )
artifact_map = {}
...
artifact_map["@apache_karaf//:apache_karaf"] = "https://repo1.maven.org/maven2/org/onosproject/apache-karaf-offline/4.2.2-offline-20190103/apache-karaf-offline-4.2.2-offline-20190103.tar.gz"
